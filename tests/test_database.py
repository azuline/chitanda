...
def test_get_version(test_db):
    with database() as (conn, cursor):
        ...
        cursor.execute('INSERT INTO versions (version, source) VALUES (83, "a")')
        cursor.execute('INSERT INTO versions (version, source) VALUES (28, "b")')
        cursor.execute('INSERT INTO versions (version, source) VALUES (18, "b")')
        conn.commit()
